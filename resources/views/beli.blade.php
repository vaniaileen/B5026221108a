...
@section('konten')
	...
	{{ csrf_field() }}
		...
		<div class = "form-group row">
			...
			<div class = "col-sm-8">
			 <input type="number" required="required" name="kodebarang" id="kodebarang" class="form-control"> <br/>
			</div>
		</div>
		{{-- Jumlah --}}
		<div class = "form-group row">
			...
			<div class = "col-sm-8">
            <input type="number" required="required" name="jumlah" id="jumlah" class="form-control"> <br/>
			 </div>
		</div>
		{{-- Harga --}}
		<div class = "form-group row">
			...
			<div class = "col-sm-8">
			<input type="number" required="required" name="harga" id="harga" class="form-control"> <br/> <br/>
			 </div>
		</div>
